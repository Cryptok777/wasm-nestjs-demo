...
* @returns {SignableTransaction}
*/
export function createTransaction(utxo_entry_source: any, outputs: any, network_type: any, priority_fee: bigint, payload: any, sig_op_count: any, minimum_signatures: any): SignableTransaction;
/**
* Creates a set of transactions using transaction [`Generator`].
* @param {any} settings
* @returns {Promise<object>}
*/
export function createTransactions(settings: any): Promise<object>;
/**
* Creates a set of transactions using transaction [`Generator`].
* @param {any} settings
* @returns {Promise<GeneratorSummary>}
*/
export function estimateTransactions(settings: any): Promise<GeneratorSummary>;
/**
